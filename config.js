// config.js (dans sekhamet-evolution/)
...
window.ALLOWED_APP_IDS = ["fondation","origine", "enveloppe", "emergence"];
...
window.PROGRAM_FLOW = ["fondation","origine","enveloppe","emergence"]
